...
Ví dụ:
để ssh tới ubuntu ở , user là admin thì mở CMD trên windows,
gõ lệnh: ssh traiktpro@127.0.0.1 -p 2222
...
<img width="719" height="764" alt="image" src="https://github.com/user-attachments/assets/54fafbc4-4fbc-4171-bab8-b79cd9c97d01" />
Tìm hiểu các lệnh cơ bản của ubuntu
Các lệnh cần tìm hiểu:
Liệt kê các file trong thư mục: ls
<img width="516" height="180" alt="image" src="https://github.com/user-attachments/assets/2bca36f1-2ca3-44ed-a012-afbf82a4b131" />
